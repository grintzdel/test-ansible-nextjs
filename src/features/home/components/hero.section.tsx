...
export const HeroSection: React.FC = (): React.JSX.Element => {
  return (
    <section className="bg-[#A0F1BD]">
        <div className="container max-w-[1280px] mx-auto flex flex-col md:flex-row gap-6 justify-between items-center p-6 md:py-12 md:px-8 lg:py-25 lg:px-10">
            ...
            <Image
                ...
                width={800}
                height={600}
                className="max-w-[429px] aspect-square"
            />
        </div>
    </section>
  );
